// We have provided the space complexity analysis for completeness. You'll only
// be assessed on time complexity for this module.
...
function fastDance(direction, tilesHash) {
  return tilesHash[direction];
}
